...
public class SongAdapter3 extends BaseAdapter {
    private Context context;
    private int layout;
    private List<Song> songList,songListSave;


    public SongAdapter3(Context context, int layout, List<Song> songList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.songArtist2.setText(s.getArtist());
        viewHolder.songTitle2.setText(s.getTitle());
        viewHolder.songCover2.setImageResource(s.getCover());
        return convertView;
    }
